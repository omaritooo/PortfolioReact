export const BlockHyperlinks = () => {
  return (
    <div className="container hidden lg:block bg-transparent">
      <div className="relative flex items-end justify-between z-50">
        <div className="fixed bottom-0 flex flex-col justify-end gap-y-4 items-center h-[200px] translate-x-6  w-[20px]">
          <div className="flex flex-col gap-y-4 w-full text-black dark:text-white">
            <a
              aria-label="Github"
          ...
          <div className="w-[2px] bg-black dark:bg-white h-[140px]"></div>
        </div>
      </div>
    </div>
  );
